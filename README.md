...
9. Обработка признаков и работа с выбросами
10. Снижение размерности данных
11. Кластеризация данных
12. Интерпретируемость ML-моделей
13. Рекомендательные системы и ранжирование
14. AutoML
